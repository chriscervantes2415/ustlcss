...
<html>
  ...
  <body class="hold-transition skin-white layout-top-nav" onload="myFunction()">
    <div style="background-color:#7E3517;" class="wrapper" style="color:red;">
  ...
  background-color: gray; 
        ...
        <div class="container">
          ...
          <section class="content">
            <div class="row">
	      <div class="col-md-9">
              <div style = "position:relative; left:250px; top:25px; class="box box-warning">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date" style="color:white;">Add School Year</label><br>
								<input type="text" class="form-control" name="sy" placeholder="yyyy-yyyy" required>
