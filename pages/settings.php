      ...
      <div class="content-wrapper">
        <div class="container" style="color:white;">
          ...
          <section class="content">
            <div class="row">
            <div style = "position:relative; left:120px; top:15px;" class="col-md-10">
...
<?php }?>           
		...
		<div class="col-md-6">
            ...
            <div class="col-md-3">
            <!-- <div style = "position:fixed; top:115px; left:50px;  background-color:#f5cb42;" >  -->
                <div style="position:fixed; top:115px; left:50px; background-color:#7E3517; " class="box-body">
                  <!-- Date range -->
                  <div id="form">
