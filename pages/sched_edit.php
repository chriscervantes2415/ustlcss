      ...
      <div class="content-wrapper">
        <div class="container">
		  ...
		  <div style = "position:relative; left:250px; top:2px; class="box box-warning">
				  ...
				  <h4 style="color:white;" > Print Class Schedule
			   ...
			   <div style="background-color:#f5cb42;background-color:#f5cb42;border:red; border-width:5px; border-style:dashed;" >
				<div class="row">
					<div class="col-md-6">
		...
		<div class="col-md-5">
			...
			<th>SCHEDULING RESULT</th>
			<div 
			style="background-color:white;" 
			class="result" id="form">
					  </div>			
         </div><!--col end-->           
        </div><!--row end-->        
            ...
            <div class="col-md-5">
			<div style = "position:relative; right:170px; bottom:610px; class="box box-warning">
