      ...
      <div class="content-wrapper">
        <div class="container" style="color:white;">
          ...
          <section class="content">
            <div class="row">
            <div style = "position:relative; left:120px; top:15px;" class="col-md-11">
            <div style = "position:relative; left:120px; top:15px; background-color:#7E3517;">
...
.table tr:nth-child(even) { 
  background-color: gray; 
				...
				<div class="row">
					<div class="col-md-12">
						<table id="example1" class="table table-bordered " style="margin-right:-10px">
              <thead>
                <tr>
                <th>Salutation</th>
                <th>Last Name</th>
...
<?php }?>           
		...
		<div class="col-md-6">
            ...
            <div style = "position:fixed; right:530px; bottom:260px;" class="col-md-2 ">
              <div  style = "position:relative; right:720px; top:105px;">
              ...
              <label for="date">Status</label>
                ...
                <select class="form-control select2" name="status" required>
                  ...
                  <div class="form-group">
					  ...
					  <button class="btn btn-lg" id="daterange-btn" type="reset" style="color:black;">
                       Cancel
                      </button>
