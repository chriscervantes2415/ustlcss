      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content">
            <div class="row">
            <div style = "position:relative; left:120px; top:15px;" class="col-md-9">
              <div style = "position:relative; left:120px; top:15px; background-color:#f5cb42;">
               
                <div style = "border:red; border-width:5px; border-style:dashed;" class="box-body">
				<div class="row">
					<div class="col-md-12">
...
<?php }?>           
		...
		<div class="col-md-6">
            ...
            <div class="col-md-3">
            <div style = "position:fixed; right:1250px; top:120px; class="box box-warning">
                <div style="background-color:#f5cb42; border:red; border-width:5px; border-style:dashed;" class="box-body">
