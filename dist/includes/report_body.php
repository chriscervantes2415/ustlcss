...
<table style="width:50%;float:left">
		...
		<?php }?>					  
			...
			?>
								...
								if ($member<>"")
								{
									$query2=mysqli_query($con,"select * from schedule natural join member where day='s' and schedule.member_id='$member' and time_id='$id' and settings_id='$sid'")or die(mysqli_error($con));
								}
								elseif ($room<>"")
								{
									$query2=mysqli_query($con,"select * from schedule natural join member where day='s' and schedule.room='$room' and time_id='$id' and settings_id='$sid'")or die(mysqli_error($con));
								}
								elseif ($class<>"")
								{
									$query2=mysqli_query($con,"select * from schedule natural join member where day='s' and schedule.cys='$class' and time_id='$id' and settings_id='$sid'")or die(mysqli_error($con));
								}
										$row2=mysqli_fetch_array($query2);
										$count=mysqli_num_rows($query2);
										$id1=$row2['sched_id'];
